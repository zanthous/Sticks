...
void main(void)
{
    ...
    // R stores right-stick coverage and G stores left-stick coverage, independently of the palette.
    // Component-wise maximum blending retains both masks at crossings regardless of draw order,
    // allowing intersections to use the configured overlap colour.
    ...
    // B carries a normalised distance field across a narrow band inside each ribbon edge.
    ...
    // Apply the pulse after edge lighting while protecting the coloured boundary itself.
