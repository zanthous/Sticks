...
{
    public partial class DrawableSticksHoldHead : DrawableHitObject<SticksHoldHead>
    {
        ...
        public DrawableSticksHoldHead()
            : this(null!)
        {
        }

        public DrawableSticksHoldHead(SticksHoldHead hitObject)
            : base(hitObject)
        {
            Alpha = 0;
            AlwaysPresent = true;
        ...
        {
            // The parent hold owns the physical head-acquisition gesture.
        }
